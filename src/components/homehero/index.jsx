...
export default function HomeHero({
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        !malasiaRef.current.contains(event.target)
      ) {
        setDrop(false);
      }
    };
  ...
  return (
    <Container className={styles.herocontainer} fluid>
      <div className={`${styles.slowrotate} ${styles.snakebg}`}></div>
              ...
              >
                <div className="my-auto ms-4 position-relative">
                  ...
                  <div
                    ...
                    className="d-flex"
                  >
                    <div className="my-auto">{option_cta_default}</div>
                    <div className="my-auto ms-1">
                      <Image
                        src="/hero_arrow_down.svg"
                        width={20}
                        height={20}
                        alt="arrow"
                      />
                        ...
                        return (
                          ...
                          >
                            <div className="d-flex w-100">
                              <div className="my-auto me-auto">{each.text}</div>
                ...
                <div className="ms-auto my-auto">
                  <div className={styles.optioncta}>{option_cta}</div>
                </div>
              </div>
            </div>
            <center>
              <div className="d-none my-5 d-lg-flex justify-content-center">
                {hero_pills.map((each, index) => {
                  return (
                    ...
                    >
                      <div className="my-auto me-auto">{each.text}</div>
                      <div className={`ms-4 my-auto ${styles.pillArrow}`}>
                        <Image
                          src="/hero_top_right.svg"
                          width={10}
                          height={10}
