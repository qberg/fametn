...
export default function YellowHero({ hero, hero_imgs, breads }) {
  ...
  const ImageWithDesc = ({ index }) => {
    ...
    return (
      <>
        ...
        <div className={styles.imgtxt}>{description}</div>
      </>
    );
  };
        ...
        <Row>
          ...
          <Col lg={2} className="d-none d-lg-flex">
            <div className="h-100 w-100 d-flex">
              <div
                className={`my-auto position-relative w-100 ${styles.dotted}`}
              >
                <Image
                  src="/frame25.webp"
                  alt="Background"
