      ...
      <Container className="h-100 z-2 position-relative pt-5">
        <Row className="py-5">
          ...
          <Col lg={7} className="d-none d-lg-flex">
            <div className={styles.tall} ref={containerRef}>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-auto z-2 p-3 w-100">
                      <h5 className="w-100 text-wrap">{each.heading}</h5>
            ...
            <div
              ...
              onClick={() => scrollContainer(-percentageToScroll)}
            >
              <div className="m-auto">&larr;</div>
            </div>
