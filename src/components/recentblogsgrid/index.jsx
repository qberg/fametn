...
export default function RecentBlogsGrid({ blogs }) {
  ...
  return (
    <>
      {(blogOne?.title || blogTwo?.title || blogThree?.title) && (
            ...
            <Col className={styles.twomb} lg={7}>
              <div data-aos="fade-up" className={styles.newtealand}>
                ...
                <div className="my-auto">
                  ...
                  <p className="small">{blogOne.excerpt}</p>
                </div>
                <div>
                  <JustArrowButton
                    link={"/blogs/" + blogOne.url}
                    text={strings.case[locale]}
                    lightArrow={true}
                  />
                </div>
              </div>
