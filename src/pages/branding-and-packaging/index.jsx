...
export default function BrandingAndPackaging({
  news,
  data,
  packers,
  headerFooter,
  ...
  return (
    <RootLayout seo={data.seo} data={headerFooter}>
      ...
      <BrandingGallery
        data={data.section_3}
        download={data.section_3_download}
        images={data.section_3_images}
      />
      ...
      <Testimonials
        ...
        title={data.testimonial_title.heading}
        subtitle={data.testimonial_title.description}
      />
