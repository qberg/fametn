...
export default function ExposAndExhibitions({
  data,
  expo,
  news,
  headerFooter,
  ...
  return (
    <RootLayout seo={data.seo} data={headerFooter}>
      ...
      <ThreeChannel data={data.three_channel} ctaEnabled={false} />
      <PartnersSection heading={data.partners_title} data={data.partners} />
      <ExpoBlock
        title={data.expo_title}
        description={data.expo_description}
        message={data.expo_message}
        expos={expo}
      />
      <UpcomingEvents
